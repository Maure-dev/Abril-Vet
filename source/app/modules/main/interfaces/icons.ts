// Íconos usados en la app, importados desde su archivo individual de lucide-react para que el
// bundle sólo incluya estos (tree-shaking) y no la librería completa. Generado; agregá acá los
// íconos nuevos. Los componentes importan desde este módulo, no desde "lucide-react".
