import type { DewormingStatusType } from "@app/modules/dewormings/entities/entities";

// Función pura: calcula el estado de una desparasitación a partir de su próxima dosis.
